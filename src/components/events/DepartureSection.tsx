...
const DepartureSection = () => {
  ...
  const handleStartDeparture = () => {
    ...
    toast({
      ...
      description: `Saída da ordem #${orderNumber} iniciada com sucesso`
    });
  };
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <DepartureStepCard 
              title="Separar Itens"
              description="Selecione e separe os itens para saída"
            ...
            <DepartureStepCard 
              title="Embalar e Preparar"
              description="Prepare os itens para transporte"
            ...
            <DepartureStepCard 
              ...
              description="Confirme e registre a saída no sistema"
